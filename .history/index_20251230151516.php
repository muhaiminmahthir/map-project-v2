            ...
            <div class="sidebar-content">
                ...
                <div class="layer-section">
                    ...
                    <div class="overlay-control">
                        <div class="layer-item" data-layer="buildingPlan">
                            <input type="checkbox" class="layer-checkbox" id="layer-buildingPlan" checked>
                            <div class="layer-icon buildingPlan"></div>
                            <label class="layer-name" for="layer-buildingPlan">Building Plan (TIFF)</label>
                        </div>
