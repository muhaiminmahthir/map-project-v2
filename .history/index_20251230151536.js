...
const wmsLayers = {
        ...
        version: '1.1.0',
        maxZoom: 20,
        opacity: 0.6  // Adjust this value: 0 = fully transparent, 1 = fully opaque
    }),
...
if (opacitySlider && opacityValue) {
    opacitySlider.addEventListener('input', (e) => {
        ...
        if (wmsLayers.buildingPlan) {
            wmsLayers.buildingPlan.setOpacity(opacity);
        }
