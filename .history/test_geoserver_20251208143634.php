...
if ($errno) {
    ...
    echo "<ul>";
    echo "<li>GeoServer is not running on 35.187.255.127:8080</li>";
    echo "<li>Firewall is blocking port 8080</li>";
    ...
    echo "curl -I http://35.187.255.127:8080/geoserver/web/\n\n";
    echo "# Test with telnet:\n";
    echo "telnet 35.187.255.127 8080\n\n";
    echo "# Check if it's a DNS issue:\n";
    echo "ping 35.187.255.127\n";
    echo "</pre>";
} else {
